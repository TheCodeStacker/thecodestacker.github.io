...
function cleanupModalEvents() {
	try {
		...
		errorHandler.handleError(error, {
			type: 'cleanup_modal_events',
			location: 'languageModal.cleanupModalEvents'
		});
	}
}
...
export function renderLanguageModal() {
	try {
		...
		if (!modal || !closeBtn) {
			throw new Error('Language modal elements not found');
		}
		...
		eventHandlers.modalClickHandler = e => {
			try {
				...
				errorHandler.handleError(error, {
					type: 'modal_click',
					location: 'languageModal.modalClickHandler'
				});
			}
		};
		...
		eventHandlers.closeClickHandler = () => {
			try {
				...
				errorHandler.handleError(error, {
					type: 'close_click',
					location: 'languageModal.closeClickHandler'
				});
			}
		};
				...
				eventHandlers.langClickHandlers[code] = () => {
					try {
						...
						errorHandler.handleError(error, {
							...
							location: 'languageModal.langClickHandler',
							selectedLang: code
						});
					}
				};
		...
		errorHandler.handleError(error, {
			type: 'render_language_modal',
			location: 'languageModal.renderLanguageModal'
		});
	}
}
...
export function openLanguageModal() {
	try {
		...
		errorHandler.handleError(error, {
			...
			location: 'languageModal.openLanguageModal'
		});
	}
}
...
export function closeLanguageModal() {
	try {
		...
		errorHandler.handleError(error, {
			...
			location: 'languageModal.closeLanguageModal'
		});
	}
}
...
function updateModalHighlight() {
	try {
		...
		errorHandler.handleError(error, {
			type: 'update_modal_highlight',
			location: 'languageModal.updateModalHighlight'
		});
	}
}
