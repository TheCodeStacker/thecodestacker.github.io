...
function addTrackedEvent(element, event, handler) {
	try {
		...
		errorHandler.handleError(error, {
			...
			location: 'styles.addTrackedEvent',
			event
		});
	}
}
	...
	try {
		...
		container.querySelectorAll('p').forEach((p, i) => {
			try {
				...
				errorHandler.handleError(error, {
					...
					location: 'styles.applyStyles.paragraph'
				});
			}
		});
		...
		container.querySelectorAll('ol').forEach(ol => {
			try {
				...
				errorHandler.handleError(error, {
					type: 'style_ordered_list',
					location: 'styles.applyStyles.ol'
				});
			}
		});
		...
		container.querySelectorAll('ul').forEach(ul => {
			try {
				...
				errorHandler.handleError(error, {
					type: 'style_unordered_list',
					location: 'styles.applyStyles.ul'
				});
			}
		});
		...
		container.querySelectorAll('code').forEach(code => {
			try {
				...
				errorHandler.handleError(error, {
					type: 'style_code',
					location: 'styles.applyStyles.code'
				});
			}
		});
		...
		container.querySelectorAll('pre').forEach(pre => {
			try {
				...
				errorHandler.handleError(error, {
					type: 'style_pre',
					location: 'styles.applyStyles.pre'
				});
			}
		});
		...
		container.querySelectorAll('blockquote').forEach(bq => {
			try {
				...
				errorHandler.handleError(error, {
					type: 'style_blockquote',
					location: 'styles.applyStyles.blockquote'
				});
			}
		});
		...
		container.querySelectorAll('table').forEach(table => {
			try {
				...
				errorHandler.handleError(error, {
					type: 'style_table',
					location: 'styles.applyStyles.table'
				});
			}
		});
		...
		container.querySelectorAll('tbody tr').forEach((tr, i) => {
			try {
				...
				errorHandler.handleError(error, {
					type: 'style_table_row',
					location: 'styles.applyStyles.tbody'
				});
			}
		});
		...
		container.querySelectorAll('dl').forEach(dl => {
			try {
				...
				errorHandler.handleError(error, {
					type: 'style_dl',
					location: 'styles.applyStyles.dl'
				});
			}
		});
		...
		container.querySelectorAll('details').forEach(details => {
			try {
				...
				errorHandler.handleError(error, {
					type: 'style_details',
					location: 'styles.applyStyles.details'
				});
			}
		});
		...
		container.querySelectorAll('a[href^="http"]').forEach(link => {
			try {
				...
				errorHandler.handleError(error, {
					type: 'style_external_link',
					location: 'styles.applyStyles.externalLinks'
				});
			}
		});
		...
		container.querySelectorAll('img').forEach(img => {
			try {
				...
				errorHandler.handleError(error, {
					type: 'style_image',
					location: 'styles.applyStyles.img'
				});
			}
		});
		...
		container.querySelectorAll('h1, h2, h3, h4, h5, h6').forEach(h => {
			try {
				...
				errorHandler.handleError(error, {
					type: 'heading_id',
					location: 'styles.applyStyles.headings'
				});
			}
		});
		...
		try {
			...
			backToTopObserver = new IntersectionObserver(
				([e]) => {
					try {
						...
						errorHandler.handleError(error, {
							type: 'back_to_top_observer',
							location: 'styles.backToTopObserver'
						});
					}
				},
				{ threshold: [1] }
			...
			errorHandler.handleError(error, {
				type: 'back_to_top_button',
				location: 'styles.applyStyles.backToTop'
			});
		}
	} catch (error) {
		errorHandler.handleError(error, {
			type: 'apply_styles',
			location: 'styles.applyStyles'
		});
	}
}
